...
load('./Results2/nback_object_pac_firpm.mat'); %nBackCalculator

recs = numel(nBackCalculator); % all recordings
recs = 1; % 1-12 are 2019 recordings (eeeeeecx), 13-20 are 2020:
...
xlsFileName = 'testi_2019_G1_PAC_firpm_2.xlsx';
